...
# # ---------- EAD ---------- 
compute_ead(df_global, vars = vars + target, results_root="results/data_analysis/ead/global")

# # ----------- Feature selection -------------- 
# ----------- Filter methods --------------
filter_feature_selection(df_global, X_vars = vars, y_var="qP", out_dir="results/feature_selection/global/filter/qP")
filter_feature_selection(df_global, X_vars = vars, y_var="rP", out_dir="results/feature_selection/global/filter/rP")

# --------- Wrapper & Embedded methods ------------
WnE_feature_selection(df_global, X_vars = vars, y_var="qP", model_names_w=wrapper_models, 
                      model_names_p=permutation_models, out_path="results/feature_selection/global/wnp/qP")
WnE_feature_selection(df_global, X_vars = vars, y_var="rP", model_names_w=wrapper_models, 
...
# # ---------- EAD ---------- 
compute_ead(df_global_ind, vars = vars + target, results_root="results/data_analysis/ead/global_ind")

# # ----------- Feature selection -------------- 
# ----------- Filter methods --------------
filter_feature_selection(df_global_ind, X_vars = vars, y_var="qP", out_dir="results/feature_selection/global_ind/filter/qP")
filter_feature_selection(df_global_ind, X_vars = vars, y_var="rP", out_dir="results/feature_selection/global_ind/filter/rP")

# --------- Wrapper & Embedded methods ------------
WnE_feature_selection(df_global_ind, X_vars = vars, y_var="qP", model_names_w=wrapper_models, 
                      model_names_p=permutation_models, out_path="results/feature_selection/global_ind/wnp/qP")
WnE_feature_selection(df_global_ind, X_vars = vars, y_var="rP", model_names_w=wrapper_models, 
...
# # ---------- EAD ---------- 
compute_ead(df_induction, vars = vars + target, results_root="results/data_analysis/ead/induction")

# # ----------- Feature selection -------------- 
# ----------- Filter methods --------------
filter_feature_selection(df_induction, X_vars = vars, y_var="qP", out_dir="results/feature_selection/induction/filter/qP")
filter_feature_selection(df_induction, X_vars = vars, y_var="rP", out_dir="results/feature_selection/induction/filter/rP")

# --------- Wrapper & Embedded methods ------------
WnE_feature_selection(df_induction, X_vars = vars, y_var="qP", model_names_w=wrapper_models, 
                      model_names_p=permutation_models, out_path="results/feature_selection/induction/wnp/qP")
WnE_feature_selection(df_induction, X_vars = vars, y_var="rP", model_names_w=wrapper_models, 
